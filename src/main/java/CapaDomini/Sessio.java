...
public class Sessio {
	...
	/**
	 * Construeix una sessió, possant el timer a 10 minuts del time-out en el cas de
	 * tenir moviments pendents, 20 minuts altrament.
	 * 
	 ...
	 * @throws Exception
	 */
	public Sessio(String strNom, HashSet<Partida> setPartides, int iPendents, String sqlUser, String sqlPassword)
			throws Exception {
	...
	public int getNumPartides() {
		return this.setPartides.size();
	}

	public String getUsuariNom() {
		return this.usrJugador.getNom();
	}

	public int getPartidesPendents() {
		return this.iNumPendents;
	}

	public boolean getConnectat() {
		return this.boolConnectat;
	}

	public Set<Partida> getSetPartides() {
		return this.setPartides;
	}
	...
	public void actualitzarPartides() {
		// TODO this.setPartides = this.partSQL.getPartidesPendents(this.usrJugador);
